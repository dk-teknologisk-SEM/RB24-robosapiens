...
pose_dict = {
    ...
    "just_above_screw4": [2.4195659815637685, -1.320246999157895, -2.164513015981306, -1.4626717372754792, 0.8587056135072406, 2.2711036767253683, -1.500577645809707],
    ...
    #screw hole3
    # position: 
    #     x: 0.15937225135186878
    #     y: 0.6570894065370563
    #     z: 0.03449851408898303
    # orientation: 
    #     x: 0.6881945974375837
    #     y: 0.7254861607709268
    #     z: -0.007099650081098776
    #     w: 0.0027607166297094147

    "screw_hole3": Pose(position=Point(x=0.15937225135186878, y=0.6570894065370563, z=0.03449851408898303), orientation=Quaternion(x=0.6881945974375837, y=0.7254861607709268, z=-0.007099650081098776, w=0.0027607166297094147)),  
